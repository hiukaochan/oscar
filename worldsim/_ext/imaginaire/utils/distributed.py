...
from worldsim._ext.imaginaire.utils.device import Device
...
if TYPE_CHECKING:
    from worldsim._ext.imaginaire.config import DDPConfig
...
def collate_batches(data_batches: list[dict[str, torch.Tensor]]) -> torch.Tensor | dict[str, torch.Tensor]:
    ...
    This is used for gathering validation data batches with worldsim._ext.imaginaire.utils.dataloader.DistributedEvalSampler.
