...
from worldsim._ext.imaginaire.lazy_config.lazy import LazyConfig
from worldsim._ext.imaginaire.utils import distributed, log, object_store
from worldsim._ext.imaginaire.utils.easy_io import easy_io

if TYPE_CHECKING:
    from worldsim._ext.imaginaire.config import CheckpointConfig, Config, JobConfig
...
def init_wandb(config: Config, model: ImaginaireModel) -> None:
    ...
    if isinstance(config.job, DictConfig):
        from worldsim._ext.imaginaire.config import JobConfig
