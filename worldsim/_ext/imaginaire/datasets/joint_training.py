...
import worldsim._ext.imaginaire.config
import worldsim._ext.imaginaire.datasets.webdataset.dataloader
...
def create_dataloader_dict(
    config: Config, dataloader_train: worldsim._src.imaginaire.datasets.webdataset.dataloader.DataLoader
) -> Dict:
