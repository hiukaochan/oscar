        ...
        **kwargs,
        ...
        if len(D1s) > 0:
            ...
            if order == 2:
                ...
                # CPU fallback: aarch64 PyTorch wheels lack MAGMA; this small
                # triangular system is fine on CPU.
                rhos_p = torch.linalg.solve(R[:-1, :-1].cpu(),
                                            b[:-1].cpu()).to(device).to(x.dtype)
        else:
            D1s = None
