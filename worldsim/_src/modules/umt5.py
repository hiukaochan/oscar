...
from  worldsim._ext.imaginaire.checkpointer.s3_filesystem import S3StorageReader
from  worldsim._ext.imaginaire.utils import distributed, log, misc
...
class UMT5EncoderModel:
    def __init__(
        ...
        checkpoint_path="./checkpoints/ChronoEdit-14B/models_t5_umt5-xxl-enc-bf16.pth",
...
def get_negative_emb():
    ...
    print(emb.shape)
    easy_io.dump(emb[0], "s3://checkpoints-us-east-1/cosmos_diffusion_v2/pretrain_weights/umT5_wan_negative_emb.pt")
