...
from  worldsim._ext.imaginaire.utils import distributed, log
from  worldsim._ext.imaginaire.utils.easy_io import easy_io
from worldsim._src.modules.conditioner import AbstractEmbModel
from worldsim._src.modules.umt5 import HuggingfaceTokenizer
from worldsim._src.modules.attention import attention
from worldsim._src.modules.xlm_roberta import XLMRoberta
...
def load_model_torch(model, ckpt_path, credential_path: Optional[str] = None):
    ...
    if distributed.is_rank0():
        ...
        ckpt = easy_io.load(
            ckpt_path, backend_key=backend_key, map_location="cpu", fast_backend=False, weights_only=True
        )
...
class CLIPModel:
    def __init__(
        ...
        dtype=torch.float16,
        device="cuda",
        checkpoint_path="Wan-AI/Wan2.1-I2V-14B-480P/models_clip_open-clip-xlm-roberta-large-vit-huge-14.pth",
