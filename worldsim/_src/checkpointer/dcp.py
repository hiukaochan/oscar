...
from  worldsim._ext.imaginaire.checkpointer.base import AbstractCheckpointer
from  worldsim._ext.imaginaire.config import CheckpointConfig, JobConfig
from  worldsim._ext.imaginaire.model import ImaginaireModel
from  worldsim._ext.imaginaire.utils import callback, distributed, log, misc
from  worldsim._ext.imaginaire.utils.easy_io import easy_io
from worldsim._src.models.wan_t2v_model import WANDiffusionModel as DiffusionModel
...
class DistributedCheckpointer(AbstractCheckpointer):
    ...
    def load(
        ...
        if checkpoint_path is not None and not (checkpoint_path.endswith(".pth") or checkpoint_path.endswith(".pt")):
        ...
        elif checkpoint_path is not None and (checkpoint_path.endswith(".pth") or checkpoint_path.endswith(".pt")):
